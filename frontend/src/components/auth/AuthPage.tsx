                ...
                <div className="glass-panel rounded-2xl p-8 relative overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            ...
                            className="w-full bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-lg py-2.5 font-medium text-sm flex items-center justify-center gap-3 transition-all"
                        >
